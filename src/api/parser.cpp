...
//        auto first_space = line.find(space);
//        try {
//            request.method = get_method(std::string(line.begin(), line.begin()
//            + first_space));
//        }
//        catch (std::runtime_error &ex) {
//            throw;
...
//        request.URI = std::string(line.begin() + _URI_begin, line.begin() +
//        _URI_end);
//        request.version = std::string(line.begin() + _version_begin,
//        line.begin() + _version_end);
//        return request;
//    };
...
//            auto key = std::string(line.begin() + key_begin, line.begin() +
//            key_end);
//            auto value = std::string(line.begin() + value_begin, line.begin()
//            + value_end);

//            header.fields[key] = std::move(value);
//        }
//        header.accepted =
//        GetAcceptedEncodings(header.fields[Header::Fields::Accept]);
//        header.mime_type =
//        GetMimeType(header.fields[Header::Fields::Content_Type]);
//        return header;
//    };
